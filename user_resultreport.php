          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Results Report - Filter</h3>					<!-- Überschrift Main Fenster -->
              </div>
            </div>
          <div class="clearfix"></div>
           <form action="_resultreport.php" method="post" class="form-horizontal form-label-left">	<!-- Start des Formulars -->
            <div class="row">										<!-- Start mit Zeile -->
              <div class="col-md-3 col-xs-12">	<!-- Layout der Zeile -->
                <div class="x_panel">						<!-- Start mit Panel/Fenster -->
                  <div class="x_title">
                    <h2>Select EventID</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />
                    ...
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">From</label>
                       <div class="col-md-9 col-sm-9 col-xs-12">
										...
										if (mysqli_connect_errno())
									  {
										...
										// Query  
										$query = "SELECT EventID FROM SessionLogs ORDER BY EventID";
										$result = mysqli_query($con,$query);
										?>

										<select name="EventFrom" class="select2_single form-control" tabindex="-1" id="EventFrom"><option></option>
										<?php
                    ...
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">To</label> 
                       <div class="col-md-9 col-sm-9 col-xs-12">
									  ...
									  echo "Failed to connect : " . mysqli_connect_error();
										...
										<select name="EventTo" class="select2_single form-control" tabindex="-1" id="EventTo"><option></option>
										<?php
										while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
										?>
										<option value="<?php echo $row['EventID'];?>"> <?php echo $row['EventID'];?> </option>
