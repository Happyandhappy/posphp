            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li class="active"><a href=""><i class="fa fa-globe"></i> Add Location </a></li>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Menu - Add Location</h3>					<!-- ۢerschrift Main Fenster -->
              </div>
            </div>
          <div class="clearfix"></div>
              ...
              <div class="col-md-5 col-xs-12">	<!-- Layout der Zeile -->
                <div class="x_panel">						<!-- Start mit Panel/Fenster -->
                  ...
                  <div class="x_content">
                    ...
                    <form action="add_location.php" method="post" class="form-horizontal form-label-left">	<!-- Start des Formulars -->

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Name of Location</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" class="form-control" name="Location" placeholder="Name of Location" required>
                        </div>
                      </div>
