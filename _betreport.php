...
//$query = "SELECT * FROM Bets WHERE User = '".$_SESSION['username']."' AND BetID BETWEEN '".$bet_id_from."' AND '".$bet_id_to."' AND TimeDate BETWEEN ('".$From."') AND ('".$To."')";
...
if (isset($UserName) && $UserName){
  $query = "SELECT * FROM Tickets WHERE TicketID = '".$row['TicketID']."' AND User = '".$UserName."'";
  $ticket_result = mysqli_query($con,$query);
  if (!$ticket_result){
    continue;
  }
...
<a class="btn btn-success btn-lg" href="user_betreport.php">Back ...</a>
