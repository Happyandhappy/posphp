...
require_once("timezoneslist.php");
?>
<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li class="active"><a href=""><i class="fa fa-location-arrow"></i> Edit / Delete Location </a></li>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Menu - Edit / Delete Location</h3>					<!-- ۢerschrift Main Fenster -->
              </div>
            </div>
          <div class="clearfix"></div>
            ...
            <div class="row">										<!-- Start mit Zeile -->
              ...
              <div class="col-md-5 col-xs-12">	<!-- Layout der Zeile -->
                <div class="x_panel">						<!-- Start mit Panel/Fenster -->
                  <div class="x_title">
                    <h2>Edit / Delete Location...</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />

                    <form action="edit_location.php" method="post" class="form-horizontal form-label-left">	<!-- Start des Formulars -->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          ...
                          // Query
                          $query = "SELECT * FROM Locations WHERE `LocationStatus`='Active' ORDER BY LocationID";
                          $result = mysqli_query($con,$query);
                          ?>

                          <select style="width:250px" name="LocationID" class="select2_single form-control" tabindex="-1" id="LocationID" onchange="onLocationSelect(this);" required><option></option>
                            <?php
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
						    <select class="form-control" name="Timezone" placeholder="Timezone" required>
						        <?php foreach($timezoneslist as $key=>$tzone){
                                echo '<option value="'.$key.'">'.$tzone.'</option>';
                                } ?>
                            </select>
                        </div>
                      </div>
        ...
        <div id="confirm_del_location" title="Confirm to delete location" style="display:none; margin-top: 50px; overflow: hidden;">
          <div class="row" style="text-align: center">
            <div class="row" style="margin: 20px;">
              <label>Users are using this location , continue ?</label>
            </div>
            <div class="row">
              <div class="col-md-12 col-xs-12" >
                <button id="btn-dialog-ok" class="btn-custom btn-dialog"><h4><b>Continue</b></h4></button>
    ...
    <script>
      function onLocationSelect(param){
        var location_id = param.value;
        if (location_id <= 0){
          alert('error');
          return;
        }
        $.ajax({
          ...
          dataType : 'JSON',
          cache : false,
          data: {action: 'get_location', location_id:location_id},
          success(res){
            switch (res.code){
              case 0:
                console.log(res.data);
                $('input[name="Location"]').val(res.data.Location);
                $('input[name="Region"]').val(res.data.Region);
				$('[name="Timezone"]').val(res.data.Timezone);
                return;
                break;
              default:
      ...
      $(document).ready(function() {
        $("#confirm_del_location").dialog({
          ...
          open: function(event, ui) {
            ...
            $('#btn-dialog-ok').click(function(){
              $("#confirm_del_location").dialog("close");
        ...
        $('#btn_delete').click(function(event){
          if (accept == 0){
              $("#confirm_del_location").dialog("open");
