          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Bet Report - Filter</h3>					<!-- Überschrift Main Fenster -->
              </div>
            </div>
          <div class="clearfix"></div>
           <form action="_admin_betreport.php" method="post" class="form-horizontal form-label-left">	<!-- Start des Formulars -->
                    ...
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">From</label>
                       <div class="col-md-9 col-sm-9 col-xs-12">
									  ...
									  echo "Failed to connect : " . mysqli_connect_error();
										...
										<select name="TicketIDFrom" class="select2_single form-control" tabindex="-1" id="TicketIDFrom"><option></option>
										<?php
										while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                                          ...
                                          foreach ($bet_id_list as $bet_id){
                                            ?>
                                            <option value="<?=$bet_id?>"> <?=$bet_id?> </option>
                                            <?php
                                          }
                                          unset($bet_id_list);
										}
                    ...
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">To</label> 
                       <div class="col-md-9 col-sm-9 col-xs-12">
									  ...
									  echo "Failed to connect : " . mysqli_connect_error();
										...
										<select name="TicketIDTo" class="select2_single form-control" tabindex="-1" id="TicketIDTo"><option></option>
										<?php
										while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                                          $bet_id_list = array();
                                          if ($row['BetID1'] != 0){
              ...
              <div class="col-md-3 col-xs-12">	<!-- Layout der Zeile -->
                <div class="x_panel">						<!-- Start mit Panel/Fenster -->
                  ...
                  <div class="x_content">
                    ...
                    <br><center style="margin-bottom: 3px"><b>Select Date From - Date To</b></center><br>
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-prepend input-group">
                                ...
                                <input type="text" name="Daterange" id="reservation" class="form-control" value="" />
                              </div>
                            </div>
                          </div>
											<br />
                    ...
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Location</label>
                       <div class="col-md-9 col-sm-9 col-xs-12">
									  ...
									  echo "Failed to connect : " . mysqli_connect_error();
										...
										// Query  
										$query = "SELECT Location FROM Locations ORDER BY Location";
										$result = mysqli_query($con,$query);
										?>

										<select name="Location" class="select2_single form-control" tabindex="-1" id="Location" ><option></option>
										<?php
										while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
										?>
                    ...
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">User</label> 
                       <div class="col-md-9 col-sm-9 col-xs-12">
									  ...
									  echo "Failed to connect : " . mysqli_connect_error();
										...
										<select name="UserName" class="select2_single form-control" tabindex="-1" id="UserName" ><option></option>
										<?php
										while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
										?>
