        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
          <div class="menu_section">
            ...
            <ul class="nav side-menu">
                  <li><a href="user_betplace.php"><i class="fa fa-check-square-o"></i> Realizar Apuestas </a></li>
                  <li><a href="user_ticketcancel.php"><i class="fa fa-eraser"></i> Cancelar Entradas </a></li>
                  <li><a href="user_betpay.php"><i class="fa fa-credit-card"></i> Pagar Apuestas </a></li>
                  <li class="active"><a href="javascript:void(0)"><i class="fa fa-pencil-square-o"></i> Informe de Resultados </a></li>
                  <li><a href="user_betreport.php"><i class="fa fa-list-alt"></i> Informe Apuesta </a></li>
			      <li><a href="user_betsummary.php"><i class="fa fa-list-alt"></i> Resumen de las Apuestas </a></li>
              <br/>
                ...
                <div class="col-md-5 col-xs-5">
                  <div class="row">
                    <div class="col-md-4 col-xs-4">
                      <h4 style="font-weight: bold;">Winning TicketID</h4>
                    </div>
                    <div class="col-md-4 col-xs-4">
                      <input type="text" class="form-control" name="BetID" placeholder="Type TicketID" required>
                    </div>
                  </div>
                </div>
              </div>
  ...
  $(document).ready(function() {
    ...
    $("#btn-confirm").click(function(){
      ...
      $.ajax({
        ...
        dataType : 'JSON',
        cache : false,
        data: {action: 'pay_bet', data:ticket_id},
        success(res){
          console.log(res.data);
          alert('Apuestas con éxito pagados.');
          for (i = 0; i < ticket_id.length; i++){
            $('#bet-pay-'+ticket_id[i]).parent().remove();
          }
          ticket_id = [];
    ...
    $("#btn-cancel").click(function(){
      ...
      for (i = ticket_id.length - 1; i >= 0; i--){
        $('#bet-pay-' + ticket_id[i]).find("div").each(function(){
          $(this).removeClass('ticket-sel');
        });
        ticket_id.splice(i, 1);
      }
    });
    $('input[name="BetID"]').change(function(){
      $("#ticket-list").load("user_betpay_item.php", { ticket_id: $(this).val() }, function(){
        $(".btn-mark").click(onMarkButton);
      });
    });
