    ...
    <div class="container body">
      <div class="main_container">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li class="active"><a href="javascript:void(0)"><i class="fa fa-list-alt"></i> Bet Report </a></li>
        ...
        <div class="right_col" role="main">
          ...
          <div class="clearfix"></div>
           <form action="_betreport.php" method="post" class="form-horizontal form-label-left">	<!-- Start des Formulars -->
              ...
              <div class="col-md-3 col-xs-12">	<!-- Layout der Zeile -->
                <div class="x_panel">						<!-- Start mit Panel/Fenster -->
                  ...
                  <div class="x_content">
                    ...
                    <br><center style="margin-bottom: 3px"><b>From Date - To Date</b></center><br>
      ...
      $(document).ready(function() {
        ...
        var optionSet1 = {
          ...
          locale: {
            ...
            daysOfWeek: ['Dom', 'Lun', 'Mar', 'Mei', 'Jue', 'Vie', 'Sab'],
