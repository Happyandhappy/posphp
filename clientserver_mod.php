    	...
    	try {
	        ...
	        // 5. meta message
	        	...
	        	foreach ($eventList as $eventInfo) {
					...
					$timemarket = $eventInfo['@attributes']['timemarket'];
					$vidtime = $eventInfo['@attributes']['vidtime'];
	        		//$activeStatusId = $eventInfo['@attributes']['activestatusid'];
	        		
	        		$sql = "update SessionLogs set EventStatus = '{$eventStatus}', BetStatus= '{$betStatus}', Winner='{$winner}', timemarket='{$timemarket}', vidtime='{$vidtime}' where EventID = '{$eventId}'";
	        		db_query($sql);
	        	}
	        }
	        // 6. create session 
	        	...
	        	foreach ($eventList as $eventInfo) {
					...
					$time1 = $eventInfo['@attributes']['time1'];
					$time2 = $eventInfo['@attributes']['time2'];
					$timeodds1 = $eventInfo['@attributes']['timeodds1'];
					$timeodds2 = $eventInfo['@attributes']['timeodds2'];
	        		...
	        		$sql = "insert into SessionLogs set EventStatus = '{$eventStatus}', BetStatus= '{$betStatus}', ActiveStatus = '{$activeStatusId}'
						...
						, time1 = '{$time1}', time2 = '{$time2}', timeodds1 = '{$timeodds1}', timeodds2 = '{$timeodds2}'";
	        		db_query($sql);
	        	}
